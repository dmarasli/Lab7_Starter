...
self.addEventListener('install', function (event) {
   ...
   */
   var urlsToCache = ['assets/styles/main.css',
...
self.addEventListener('activate', function (event) {
   ...
   * 
   * inside service worker's "activate" event listener so that clients 
   * loaded in the same scope do not need to be reloaded before their 
